...
object FunSets {
   ...
   */
  type Set = Int => Boolean //Set is a function, take a int, return a bool
//https://stackoverflow.com/questions/13052735/is-my-understanding-of-below-scala-code-correct
  /**
